...
export default function Header() {
    const location = useLocation(), headerLinksRef = useRef(null);
        ...
        headerLinksRef.current?.querySelectorAll("a").forEach((link) => {
            if (
                (link.getAttribute("href") === "/" &&
                    document.documentElement.getAttribute("data-location") ===
                        "/") ||
                (document.documentElement.getAttribute("data-location") !==
                    "/" &&
                    link.getAttribute("href") !== "/" &&
                    document.documentElement
                        ...
                        .startsWith(link.getAttribute("href")))
            ) {
    ...
    return (
        <div id="header">
            <div className="tlačítka">
                <button
                    type="button"
                    aria-label="Set theme to default"
