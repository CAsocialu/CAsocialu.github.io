    ...
    return (
        <div className="twtprofile-profile-container">
            <div className="twtprofile-profile-header">
                <img src="/assets/pfpCAsocialu.jpg" alt="PFP" className="twtprofile-profile-photo" />
                <div className="twtprofile-profile-actions">
                    <a className="twtprofile-follow-btn" href="https://x.com/CAsocialu" target="_blank" rel="noreferrer" onClick={handleFollow} style={{ padding: clickedFollowed ? "8px 12px 8px 16px" : "8px 16px" }}>
            ...
            <div className="twtprofile-profile-info">
                ...
                <p className="twtprofile-description">Česká Strana Asociálů je rozhodně existující stranou, která chce pro česko jen to dobré. Třeba zrušit gravitaci či vystoupení z r/2vysegrad4you</p>
