        ...
        <>
            ...
            <div id="mainContent">
                ...
                <div id="mainACTUALContent">
                    <img src={logoPainting} alt="Logo ČSA" style={{gridColumn: "1", width: "100%"}} draggable="false"/>
                    ...
                    <img src={předsedovéPainting} alt="Předsedové strany na tiskovke" style={{gridColumn: "3", width: "100%"}} draggable="false"/>
                </div>
            </div>
        </>
    )
