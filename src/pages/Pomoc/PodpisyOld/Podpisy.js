        ...
        <div id="signaturesContent">
            ...
            <div id="signaturesContentWrapper">
                ...
                <Notification
                    ...
                    link="/assets/Petice.pdf"
                    isLinkInternal={false}
                    style={{ marginBottom: "12px" }}
                    contentStyle={{ background: "var(--asocial-green-dark)", border: "2px var(--asocial-green) solid" }}
                />
                ...
                <p>
                    Na webu i v linktree máme →{" "}
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLScR7vYZjbuzH8do5-OYTCfQR18WmnuNvie-u3Z9aqAW41R71A/viewform?usp=sf_link" target="_blank" rel="noopener noreferrer">
                        odkaz na přihlášku
                    </a>{" "}
                    ←. Sami se ozveme po tom, co ji vyplníte. Pozveme vás na discord a dáme vám roli, díky které potom budete moct komunikovat ve speciálních kanálech.
                </p>

                <h3>CO DOSTANETE?</h3>
                <p>
                    NIC! <em>Počkej, jakože ani dobrý poc-</em>
                    <strong>NIC!</strong> DOBRÝ POCIT SI NECHÁVÁME PRO SEBE! SAMI MÁME MÁLO! Nic nedostanete!
                </p>
