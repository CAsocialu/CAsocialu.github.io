...
export function ZbírkaTitle() {
    return <Title>Chci pomoci</Title>;
}
export function ZbírkaNotifikace() {
    return (
...
export default function Zbírka({ finished }) {
    const STARTOVAC_TIERS = [
        { price: 1, reward: "Dobrý pocit", description: "Pokud přispějete jakoukoli částku, dostanete dobrý pocit! Výrobci antidepresiv ho nenávidí! Tito mladíci vytvořili levný způsob na vyléčení smutku! Takové moderní odpustky, jen místo pro zalíbení se bohu to posíláte pro zalíbení se kočičce.", link: "https://www.startovac.cz/projekty/ceskastranaasocialu-2/prispet/gJDzZe8rZ", image: tier0 },
        { price: 200, reward: "4 karty, 4 samolepky a 1 placka", description: "Karty na způsob hry Pokémon nebo Magic: The Gathering. Pošleme vám náhodné karty, přičemž to, kolik přispějete určuje to, kolik jich dostanete. O kartách vás budeme informovat až po skončení sbírky, pouze až budeme mít peníze a budeme vědět počet karet, které budeme vyrábět. Způsob doručení pořešíme po sbírce, tudíž zachovejte si své potvrzení o platbě.\nS těmito kartami se bude moct skutečně hrát, ovšem my víme, že jste praví asociálové a s nikým to hrát nebudete. Karty jsou automatický repelent na kamarády.", link: "https://www.startovac.cz/projekty/ceskastranaasocialu-2/prispet/XKbz7DaGJ", image: tier1 },
        { price: 600, reward: "7 karet, 7 samolepek, a 2 placky", description: "Krásné nádherné zbrusunové samolepky s tak moc zbrusunovým designem, že jsme je ještě ani nestihli navrhnout. Respektive máme jeden design a mnoho dalších nás čeká.", link: "https://www.startovac.cz/projekty/ceskastranaasocialu-2/prispet/GQg9WR81e", image: tier2 },
        { price: 1000, reward: "10 karet, 10 samolepek, a 3 placky", description: "Staré dobré placky. Rozdávali jsme je na ČSA srazu a rozdáváme je i teď! No nejsme my prostě skvělí lidé, které byste měli volit?", link: "https://www.startovac.cz/projekty/ceskastranaasocialu-2/prispet/jYLMxDOEz", image: tier3 }
    ];
    ...
    return (
        <>
            ...
            <div id="helpContentColOne">
                ...
                <p>
                    <strong>Česká Strana Asociálů</strong> je rozhodně existující strana, která ještě neexistuje. A proto potřebujeme vaše peníze na pomoc se založením první naprosto smysl nedávající strany! Zní to skutečně věrohodně? Ne! Ale můžete si užít ten uspokojivý gambling. 50% šance, že peníze půjdou na lidi zakládající vtipostranu, 50% na to, že peníze půjdou pirátům do Somálska. A to se vyplatí, Horste!
                </p>
                ...
                <p>
                    <strong>DÁVEJTE NÁM POUZE PENÍZE, KTERÉ NEPOTŘEBUJETE. V ŽÁDNÉM PŘÍPADĚ NÁM NEPOSÍLEJTE VÍCE PENĚZ JEN PROTO, ŽE CHCETE VÍC ODMĚN POKUD BY TO PRO VÁS ZNAMENALO JAKÉKOLI FINANČNÍ RIZIKO. NEJLEPŠÍ ODMĚNA BY PRO VÁS MĚL BÝT DOBRÝ POCIT! Ale pokud se vám zrovna chce dát všechny vaše úspory nám, zlobit se nebudeme.</strong>
                </p>
                <p>
                    <strong>Děkujeme za podporu.</strong>
                </p>
                <p>ČSA &lt;3</p>
            </div>
            <div id="helpContentColTwo">
                ...
                {STARTOVAC_TIERS.map((tier, index) => (
                    <StartovacTier key={index} {...tier} finished />
                ))}
            </div>
        </>
    );
