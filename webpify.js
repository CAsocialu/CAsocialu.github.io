...
async function replaceInFiles() {
    ...
    const codeFiles = glob.sync("**/*.{js,jsx,ts,tsx,css,scss,html}", { ignore: ["node_modules/**", "build/**", "dist/**", "webpify.js", "pre-render.js"] });
    ...
    try {
        ...
        for (const imagePath of images) {
            ...
            try {
                ...
                convertedFiles.push({ original: imagePath, webp: outputPath, status: "converted" });
